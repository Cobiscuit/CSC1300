...
int main()
{
	...
	rand(time(0)); //seed the random number generator
	...
	cout << "\nI am going to generate a random number between your minimum number and 150.";
    cout << "\nPlease enter your minimum number, which should be below 150.\n";
	cin >> userMin;
	
	//generate random number between user's number and 150 (inclusively)
	randomNumber = (srand()%(150-userMin))+userMin;
	cout << "\nThe random number is " << randomNumber << endl;
	cout << "7.5 to the power of " << userMin << " is " << 7.5^userMin << endl;
